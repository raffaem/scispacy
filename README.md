...
Additionally, scispacy uses modern features of Python and as such is only available for **Python greater than or equal to 3.6 and less than or equal to 3.12**.
